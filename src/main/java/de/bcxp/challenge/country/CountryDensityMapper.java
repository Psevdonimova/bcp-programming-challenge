...
public class CountryDensityMapper {
    private static final Logger LOG = Logger.getLogger(CountryDensityMapper.class.getName());

    public static CountryInfoList mapCountryDensity(List<String[]> lines) {
        CountryInfoList countryDensities = new CountryInfoList();
